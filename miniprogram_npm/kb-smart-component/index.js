...
var window={},document={};function init(windowObject){window = windowObject};if (true) {Object.assign(exports, { init: init });};/**
 * @license React
...
*/
'use strict';var aa=__webpack_require__(378),ca=__webpack_require__(102);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var window={},document={};function init(windowObject){window = windowObject};if (true) {Object.assign(exports, { init: init });};'use strict';
...
;// CONCATENATED MODULE: external "require(\"miniprogram-render\")"
var external_require_miniprogram_render_namespaceObject = require("miniprogram-render");
var external_require_miniprogram_render_default = /*#__PURE__*/__webpack_require__.n(external_require_miniprogram_render_namespaceObject);
// EXTERNAL MODULE: ../node_modules/react/index.js
var react = __webpack_require__(378);
// EXTERNAL MODULE: ../node_modules/react-dom/index.js
var react_dom = __webpack_require__(307);
var react_dom_default = /*#__PURE__*/__webpack_require__.n(react_dom);
;// CONCATENATED MODULE: external "require(\"kbs-dsl-resolver\")"
var external_require_kbs_dsl_resolver_namespaceObject = require("kbs-dsl-resolver");
var external_require_kbs_dsl_resolver_default = /*#__PURE__*/__webpack_require__.n(external_require_kbs_dsl_resolver_namespaceObject);
;// CONCATENATED MODULE: external "require(\"kbs-dsl-loader\")"
var external_require_kbs_dsl_loader_namespaceObject = require("kbs-dsl-loader");
var external_require_kbs_dsl_loader_default = /*#__PURE__*/__webpack_require__.n(external_require_kbs_dsl_loader_namespaceObject);
...
Object.keys = function (obj) {
  if (obj['cover-image'] && obj['cover-image'].handles) {
    ...
    Object.values(obj).forEach(function (_ref) {
      var handles = _ref.handles;
      handles && index_keys(handles).forEach(function (key) {
        var handle = handles[key];
        handles[key] = function (evt) {
...
function wxReactCreateElement(component, props) {
  ...
  return createElement.call.apply(createElement, [this, component, props].concat(others));
}
;

// 动态挂载 React
(0,external_require_kbs_dsl_resolver_namespaceObject.registerToGlobleScope)({
  React: _objectSpread(_objectSpread({}, react), {}, {
...
Component({
  ...
  attached: function attached() {
    var mpRender = external_require_miniprogram_render_default().createPage('kbone-smart', config);
    var document = mpRender.document,
      window = mpRender.window;
    // @ts-ignore
    react_dom_default().init(window);
  ...
  detached: function detached() {
    ...
    // @ts-ignore
    external_require_miniprogram_render_default().destroyPage(this.pageId);
  },
  methods: {
    // 刷新组件
